    ...
    <>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            <span className="font-bold">24/7 Support:</span> Our friendly
            customer service team is available around the clock to assist you
            with any questions or adjustments to your plans. Let us take care of
            the logistics, and you can focus on making every moment count.
          </li>
        </ul>
      </p>
    </>
